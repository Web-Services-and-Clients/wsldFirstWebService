 ...
 * generated in the com.lwazi.ws.trainings package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetOrdersRequest_QNAME = new QName("http://trainings.ws.lwazi.com/", "getOrdersRequest");
    private final static QName _GetOrdersResponse_QNAME = new QName("http://trainings.ws.lwazi.com/", "getOrdersResponse");
    private final static QName _CreateOrdersRequest_QNAME = new QName("http://trainings.ws.lwazi.com/", "createOrdersRequest");
    private final static QName _CreateOrdersResponse_QNAME = new QName("http://trainings.ws.lwazi.com/", "createOrdersResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.lwazi.ws.trainings
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://trainings.ws.lwazi.com/", name = "getOrdersRequest")
     ...
     */
    @XmlElementDecl(namespace = "http://trainings.ws.lwazi.com/", name = "getOrdersResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://trainings.ws.lwazi.com/", name = "createOrdersRequest")
     ...
     */
    @XmlElementDecl(namespace = "http://trainings.ws.lwazi.com/", name = "createOrdersResponse")
